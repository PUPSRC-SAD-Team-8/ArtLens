...
//			boolean isPasswordInvalid = AdminUtils.containsClass(findTestObject('Object Repository/admin/landing_page/input_ARTLENS_pass_1'), 'is-invalid');
			
			if(!isUsernameInvalid) {
				KeywordUtil.markFailed("Validation failed. Username has no invalid feedback: ");
				
//				if(!isPasswordInvalid) {
//					KeywordUtil.markFailed("Validation failed. Password has no invalid feedback: ");					
//				}
			}
		}
	});

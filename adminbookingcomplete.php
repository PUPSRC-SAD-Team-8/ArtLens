...
$sql = "SELECT * FROM booking WHERE book_datetime < '$currentDate' AND book_status = 'Confirmed'";
...
if ($result === false) {
    ...
    echo "<tr><td colspan='7' class='text-center'>No completed bookings found</td></tr>";
}
?>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label>Male</label>
                                        <span id="numaError" class="invalid-feedback" style="display: none;"></span> <!-- Error message container -->
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="numf" name="numf" type="number" placeholder="Number of Females" required min="0" max="50" oninput="this.value = this.value.slice(0, 2)">
                                        <label>Female</label>
                                        <span id="numfError" class="invalid-feedback" style="display: none;"></span> <!-- Error message container -->
                                    </div>
                                </div>
                            </div>
                            <div class="form-floating mb-3">

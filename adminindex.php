    ...
    <main class="content px-5 py-4">
        <div class="container">
            ...
            <div class="box" style="width: 30%; border-radius: 10px; min-width: 300px;">
                ...
                $current_visitor_query = "SELECT COUNT(*) AS current_visitors FROM visitor_log WHERE DATE(entry_timestamp) = '$current_date' AND (exit_timestamp IS NULL OR exit_timestamp > '$current_time')";
                $current_visitor_result = $conn->query($current_visitor_query);

                if ($current_visitor_result->num_rows > 0) {
                    $current_visitor_row = $current_visitor_result->fetch_assoc();
                    echo $current_visitor_row['current_visitors'];
                } else {
                    echo '0';
                }
